...
interface TuitionProps {
    ...
    subjectDb: { [key: string]: any }[];
    centerDb: { [key: string]: any }[];
};

export const Tuition: React.FC<TuitionProps> = ({
    sectionImg,
    contentDb,
    subjectDb,
    centerDb
    ...
    function onlyUnique(_array: {[key: string]: any}[], _property: string) {
        return [...new Set(_array.map(element => element[_property]))]; 
    }

    function updateMap(id: string) {
        setMapID(id);
    ...
    let set3 = contentDb.filter((e: { [key: string]: any }) => e['Section'] === 'Tuition1');
    ...
    return <>
        ...
        <ul id="subject-container" className="main-container">
            {
                set2.map(entry1 => {
                    return <li className="subject-frame" key={entry1}>
                        ...
                        <ul>
                            {
                                subjectDb.map((entry2: { [key: string]: any }) => {
        ...
        <ul id="facility-container" className="main-container">
            {
                set3.map((entry: { [key: string]: any }) => {
                    return <li className="facility-frame" key={entry.ID}>
                        ...
                        <img className="facility-img" src={entry.URL} alt={entry.Caption} />
        ...
        <div className="decorations">
            <img src="public/images/Ruler Red.svg" alt='' style={{ position: "absolute", float: "right", right: "1320px", top: "800px", width: "100px", transform: "rotate(-37.079deg)" }} />
            <img src="public/images/Circle 1 Yellow.svg" alt='' style={{ position: "absolute", float: "right", right: "1310px", top: "1500px", width: "80px" }} />
            <img src="public/images/Pencil Blue.svg" alt='' style={{ position: "absolute", left: "1300px", top: "1000px", width: "100px", transform: "rotate(64.841deg)" }} />

            <img src="public/images/Circle 1 Yellow.svg" alt='' style={{ position: "absolute", float: "right", right: "1280px", top: "4100px", width: "80px" }} />
            <img src="public/images/Dot 1 Blue.svg" alt='' style={{ position: "absolute", left: "800px", top: "4150px", width: "50px", transform: "rotate(90deg)" }} />
