...
export const Tuition: React.FC<TuitionProps> = ({
    ...
    return <>
        ...
        <div className="decorations">
            <img src="images/Ruler Red.svg" alt='' style={{ position: "absolute", float: "right", right: "1320px", top: "800px", width: "100px", transform: "rotate(-37.079deg)" }} />
            <img src="images/Circle 1 Yellow.svg" alt='' style={{ position: "absolute", float: "right", right: "1310px", top: "1500px", width: "80px" }} />
            <img src="images/Pencil Blue.svg" alt='' style={{ position: "absolute", left: "1300px", top: "1000px", width: "100px", transform: "rotate(64.841deg)" }} />

            <img src="images/Circle 1 Yellow.svg" alt='' style={{ position: "absolute", float: "right", right: "1280px", top: "4100px", width: "80px" }} />
            <img src="images/Dot 1 Blue.svg" alt='' style={{ position: "absolute", left: "800px", top: "4150px", width: "50px", transform: "rotate(90deg)" }} />
